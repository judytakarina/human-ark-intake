...
const steps = [
  ...
  { id: 6, label: "Stage", question: "What stage is the company at?", fields: [ { name: "stage", type: "radio",allowOther: true , required: true, options: ["Pre-seed", "Seed", "Series A", "Series B+", "Scale-up", "Venture studio", "Other"] } ] },
