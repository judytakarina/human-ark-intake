...
const HumanArkLogo = () => (
    <img src="/IMG_0005.jpeg" alt="Human Ark" style={{ width: "120px", height: "auto" }} />
);
...
const steps = [
  ...
  { id: 6, label: "Stage", question: "What stage is the company at?", fields: [ { name: "stage", type: "radio",allowOther: true , required: true, options: ["Pre-seed", "Seed", "Series A", "Series B+", "Scale-up", "Venture studio", "Other"], allowOther: true } ] },
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
      {field.options.map((opt) => {
        ...
        return (
          <button key={opt} onClick={() => handleOptionClick(opt)} style={{ display: "flex", alignItems: "center", gap: "14px", padding: "13px 18px", borderRadius: "4px", border: "1px solid " + (active ? GOLD : "rgba(201,168,76,0.3)"), background: active ? "rgba(201,168,76,0.08)" : "white", fontFamily: "'Cormorant Garamond', serif", fontSize: "16px", color: "#0B1F3A", cursor: "pointer" }}>
